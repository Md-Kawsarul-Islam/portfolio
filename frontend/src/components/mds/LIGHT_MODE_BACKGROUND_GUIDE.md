...
#### Greeting Badge ("Hi, I'm Md Kawsarul Islam")
- White background
- Gray border
...
- **Dynamic Image Switching**:
  - Dark mode: `/kawsarul-removebg-preview.png` (transparent bg)
  - Light mode: `/kawsarul.jpg` (with background)
...
// In render:
<img src={isDarkMode ? "/kawsarul-removebg-preview.png" : "/kawsarul.jpg"} />
```
...
- [ ] Profile image switches to kawsarul.jpg
