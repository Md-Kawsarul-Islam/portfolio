...
```json
{
  "name": "Md Kawsarul Islam Portfolio",
  "display": "standalone",
  "theme_color": "#2a015e"
}
```
...
```tsx
// ❌ Bad
<img src="/kawsarul.jpg" />

// ✅ Good
<img src="/kawsarul.jpg" alt="Md Kawsarul Islam - Full Stack Developer" />
```
...
<picture>
  <source srcset="/kawsarul.webp" type="image/webp" />
...
npx lighthouse https://kawsarul-portfolio-site.vercel.app --view

# Check accessibility
npx pa11y https://kawsarul-portfolio-site.vercel.app
