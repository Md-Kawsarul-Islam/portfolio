...
cwebp -q 85 kawsarul.jpg -o kawsarul.webp
...
```tsx
// Before:
<img src="/kawsarul.jpg" alt="Md Kawsarul Islam" />

// After:
<OptimizedImage
  src="/kawsarul.jpg"
  alt="Md Kawsarul Islam - Full Stack Developer"
  width={500}
  height={500}
  loading="lazy"
/>
...
### Use in Components:
```tsx
import heroImage from '/public/kawsarul.jpg?w=800&format=webp';

<img src={heroImage} alt="Md Kawsarul Islam" />
```
...
```tsx
<img
  src="/kawsarul-800.webp"
  srcSet="
    /kawsarul-400.webp 400w,
    /kawsarul-800.webp 800w,
    /kawsarul-1200.webp 1200w
  "
  sizes="
...
const optimizedUrl = `https://res.cloudinary.com/your-cloud/image/upload/f_auto,q_auto,w_800/kawsarul.jpg`;

<img src={optimizedUrl} alt="Md Kawsarul Islam" />
```
