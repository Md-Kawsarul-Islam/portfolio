...
- **Old**: "Md Kawsarul Islam - Full Stack Developer | React, Node.js, TypeScript Expert Portfolio" (76 chars)
- **New**: "Md Kawsarul Islam - Full Stack Developer | React & Node.js Expert" (56 chars)
