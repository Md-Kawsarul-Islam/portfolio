...
const ContactIcons = () => {
  ...
  const handleDownload = (type: 'resume' | 'cv') => {
    ...
    const fileName = type === 'resume' ? 'kawsarul_Fullstack_Resume.pdf' : 'kawsarul_CV.pdf';
  ...
  return (
      <div className="mt-3 md:mt-6 flex flex-col sm:flex-row flex-wrap items-center gap-2 sm:gap-3 justify-center lg:justify-start">
              <Dialog open={isOpen} onOpenChange={setIsOpen}>
                ...
                <DialogContent className="glass-card-extreme-transparent backdrop-blur-md max-w-sm mx-auto [&>button]:text-white [&>button]:cursor-pointer [&>button]:hover:text-gray-300">
                  <DialogHeader>
