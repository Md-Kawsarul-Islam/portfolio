...
//   const [catAnimationPhase, setCatAnimationPhase] = useState("walking"); // "walking" or "sitting"
  ...
  const terminalCommands = [
    "root@kawsarul:~# whoami",
    "Md Kawsarul Islam - Fullstack Engineer & Linux Enthusiast ",
    "root@kawsarul:~# ls -la /skills",
    ...
    "root@kawsarul:~# cat /etc/passwd | grep hacker",
    "hacker:x:1337:1337:Elite Hacker:/home/hacker:/bin/bash",
    "root@kawsarul:~# echo 'Welcome to the terminal...'",
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      if (currentIndex < terminalCommands.length) {
        ...
        setTerminalText(prev => prev + "root@kawsarul:~# ");
  ...
  const processCommand = (command: string) => {
    ...
    switch (trimmedCommand) {
      case "ls":
        ...
        break;
      case "whoami":
        response = "Md Kawsarul Islam - Linux Enthusiast & Code Assassin\nUID: 1337\nSpecialty: Fullstack Engineer";
        break;
      case "skills.sh":
      case "skills":
      case "./skills.sh":
...
echo "Name: Md Kawsarul Islam"
echo "Email: kawsarul.14780@gmail.com"
...
echo "Profile loaded successfully - Md Kawsarul Islam"
echo "Image format: ASCII Art"`;
        break;
      case "clear":
        setTerminalText("root@kawsarul:~# ");
        setCommandHistory([]);
        return;
      case "":
        response = "";
      ...
      <div className="relative z-10 pt-20">
            ...
            <div className="bg-slate-950 border-2 border-emerald-600 rounded-lg overflow-hidden shadow-2xl shadow-emerald-900/20 hover:shadow-emerald-600/30 transition-all duration-300 hover:border-red-500 dark:bg-black dark:border-green-400 dark:shadow-green-500/20 dark:hover:shadow-green-400/50 dark:hover:border-red-400 relative group terminal-interactive-glow">
              <div className="bg-slate-800 px-4 py-3 flex items-center justify-between border-b border-slate-600 dark:bg-gray-900 dark:border-gray-700">
                <div className="flex items-center">
                  <span className="text-slate-300 font-mono dark:text-gray-400">Terminal - kawsarul</span>
                </div>
        ...
        <section className="container mx-auto px-6 py-20">
          <div className="text-center">
            ...
            <p className="text-red-600 font-bold dark:text-red-400">- Md Kawsarul Islam</p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center">
              <p className="text-slate-600 mb-4 dark:text-gray-400">
                root@kawsarul:~# echo "Contact the shadows..."
              </p>
              <div className="flex justify-center space-x-6">
                <a href="https://github.com/Md-Kawsarul-Islam"
                ...
                <a href="https://www.linkedin.com/in/md-kawsarul-islamm"
                  target="_blank" className="text-emerald-700 hover:text-red-600 transition-colors dark:text-green-400 dark:hover:text-red-400">
                  LinkedIn
                </a>
              </div>
