  ...
  const getProjectDetails = (title: string) => {
    switch (title) {
      case "Visual File System Explorer":
        return {
          githubUrl: "https://github.com/Md-Kawsarul-Islam/visual-file-system-explorer",
        ...
        <div className="p-6 space-y-6">
          ...
          {/* <div className="bg-black border border-green-400 rounded p-4 font-mono">
            <div className="text-green-400 text-sm">
              <span className="text-red-400">root@kawsarul:~#</span> git clone {projectDetails.githubUrl}
              <br />
              <span className="text-gray-400"># Clone and explore the project</span>
              <br />
              <span className="text-red-400">root@kawsarul:~#</span> cd {project.title.toLowerCase().replace(/\s+/g, '-')}
              <br />
              <span className="text-red-400">root@kawsarul:~#</span> npm install && npm start
              <br />
